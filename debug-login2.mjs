...
// Clica em "Usar e-mail e senha"
const emailBtn = page.locator('button').filter({ hasText: /e-mail e senha/i }).first()
await emailBtn.click()
await page.waitForTimeout(2000)
await page.screenshot({ path: 'test-screenshots/stress-d4/debug_login_after_click.png' })
...
console.log('Inputs after click:', JSON.stringify(inputs, null, 2))
