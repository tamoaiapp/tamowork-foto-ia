...
const PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=com.tamowork.app&hl=pt_BR";
...
export default function AppRedirectPage() {
  ...
  useEffect(() => {
    ...
    if (p === "ios") {
      ...
      // iOS não standalone: mostra instruções abaixo
    } else if (p === "android") {
      // Abre Play Store
        ...
        {isAndroid && (
          <div className="fade3" style={{ textAlign: "center", marginTop: 24, width: "100%", maxWidth: 320 }}>
            <div style={{ fontSize: 15, color: "#8394b0", marginBottom: 20 }}>
              {lang === "en" ? "Opening Google Play Store..." : "Abrindo o Google Play Store..."}
            </div>
            <a href={PLAY_STORE_URL} style={{
              display: "flex", alignItems: "center", justifyContent: "center", gap: 12,
              background: "#1a1a2e", border: "1.5px solid rgba(255,255,255,0.12)",
              borderRadius: 16, padding: "16px 24px", textDecoration: "none", marginBottom: 12,
            }}>
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
                ...
                <defs>
                  <linearGradient id="ps" x1="3" y1="12" x2="20" y2="12" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#00d2ff" /><stop offset="0.5" stopColor="#00e676" /><stop offset="1" stopColor="#ffee58" />
                  </linearGradient>
                </defs>
              </svg>
