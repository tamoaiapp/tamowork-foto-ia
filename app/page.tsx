                ...
                <>
                  {narratedJob && !["done", "failed", "canceled"].includes(narratedJob.status) ? (
                    ...
                    <>
                      ...
                      {/* Roteiro — sempre obrigatório, IA melhora o texto do usuário */}
                      <div style={styles.fieldGroup}>
                        <label style={styles.label}>
                          O que você quer dizer no vídeo? <span style={{ color: "#ef4444" }}>*</span>
                        </label>
                        <textarea
                          placeholder={"Ex: Brinco de coração dourado, R$18 a unidade, atacado. Olha que lindo! Aproveita que ainda tem estoque."}
                        ...
                        />
                        <div style={{ fontSize: 11, color: "#4e5c72", marginTop: 4 }}>
                          A IA melhora seu texto para video shop e gera a narração automaticamente
                        </div>
                      </div>
