// stress-setup-d4.mjs — Provisiona conta test-stress-d4 como PRO no Supabase
...
async function main() {
  console.log('=== Setup conta PRO test-stress-d4 ===\n')
  ...
  fs.default.writeFileSync('c:/Users/Notebook/tamowork-foto-ia/stress-d4-credentials.json', JSON.stringify(creds, null, 2))
  console.log('\n=== Setup concluido ===')
  console.log(`USER_ID=${userId}`)
  console.log('Credenciais salvas em stress-d4-credentials.json')
}
